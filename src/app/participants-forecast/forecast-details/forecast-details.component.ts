...
@Component({
  selector: 'pp-forecast-details',
  templateUrl: './forecast-details.component.html',
  styleUrls: ['./forecast-details.component.scss']
})
export class ForecastDetailsComponent extends PromotionFormBase implements OnInit {
  ...
  ngOnInit(): void {
    this.initialize(NavigationLinks.forecastDetails);
  }
