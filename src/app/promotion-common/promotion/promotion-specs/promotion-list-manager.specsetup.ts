...
import { IPromotion, PromoAttribute, PromotionListManager, PromotionService } from "@app/promotion-common";
...
export class PromotionListManagerSpecSetup {
    ...
    buildPromotionListManager(): PromotionListManager<IPromotion> {
        return new PromotionListManager<IPromotion>(
