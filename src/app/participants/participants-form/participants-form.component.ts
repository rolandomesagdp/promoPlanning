...
@Component({
  selector: 'pp-participants-form',
  templateUrl: './participants-form.component.html',
  styleUrls: ['./participants-form.component.scss']
})
export class ParticipantsFormComponent extends PromotionFormBase implements OnInit {
  ...
  ngOnInit(): void {
    this.initialize(NavigationLinks.promotionParticipants);
  }
}
